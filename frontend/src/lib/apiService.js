/**
 * API Service Layer
 * Uses Backend API for chat/query when NEXT_PUBLIC_API_URL is set (Phase-4 FastAPI).
 * When unset, calls same-origin /api/* (Next.js stub routes for local run).
 * Frontend ChatInterface displays answers with citations (Sources) and error handling (error banner).
 */
